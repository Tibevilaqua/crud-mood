...
public class ProfileInfoResource {
    ...
    @Inject
    private CrudMoodProperties crudMoodProperties;
    ...
    private String getRibbonEnv() {
        ...
        String[] displayOnActiveProfiles = crudMoodProperties.getRibbon().getDisplayOnActiveProfiles();
